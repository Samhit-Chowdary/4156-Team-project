...
public class TimeOffExternalIntegrationTests {
    ...
    public void testFindAllByEmployeeIdGivenDateRange() {
        ...
        createTimeOff(empId, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 1, 10), "SICK", "PENDING", "Flu");
        createTimeOff(empId, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 5), "MATERNITY", "APPROVED", "Vacation");
        createTimeOff(empId, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 3), "SICK", "REJECTED", "Cold");

        List<TimeOff> result =
                timeOffRepository.findAllByEmployeeIdGivenDateRange(empId, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 28));
