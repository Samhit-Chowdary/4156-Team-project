...
/**
 * Represents a leave or time-off request made by an employee.
 * This entity is mapped to the "timeoff" table in the database.
 */
@Data
@Entity
@Table(name = "timeoff")
public class TimeOff implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "timeOffIdGenerationSeq",
            sequenceName = "timeoff_id_seq", allocationSize = 1)
