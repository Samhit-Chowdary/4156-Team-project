...
public class PDFGenerator {
    ...
    public void generatePdfReport(Payroll payroll) {
        ...
        try {
            ...
            System.out.println("------------------Your PDF Report is not ready!-------------------------");
        }
    }

    private void addDocTitle(Document document, Payroll payroll) throws DocumentException {
        String localDateString = payroll.getPaymentDate().format(DateTimeFormatter.ofPattern("dd MMMM yyyy"));
    ...
    private void createTable(Document document, Payroll payroll) throws DocumentException {
        ...
        List<String> columnNames = new ArrayList<>(Arrays.asList("Employee Id", "Salary", "Tax", "Net Salary"));
